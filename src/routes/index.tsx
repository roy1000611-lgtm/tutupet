...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "TUTU寵物SPA｜桃園寵物美容沙龍" },
      {
        name: "description",
        content:
          "TUTU寵物SPA沙龍館提供專業、溫柔的寵物洗沐、美容與SPA服務，讓毛孩像在家一樣安心。",
      },
      { property: "og:title", content: "TUTU寵物SPA｜桃園寵物美容沙龍" },
      {
        property: "og:description",
        content: "專業溫柔的寵物洗沐、美容與SPA服務，讓毛孩煥然一新。",
      },
...
const MAP_EMBED =
  "https://maps.google.com/maps?q=330%E6%A1%83%E5%9C%92%E5%B8%82%E6%A1%83%E5%9C%92%E5%8D%80%E6%96%87%E4%B8%AD%E9%87%8C%E6%96%87%E4%B8%AD%E4%B8%89%E8%B7%AF197%E8%99%9F&t=&z=16&ie=UTF8&iwloc=&output=embed";
              ...
              <div className="flex flex-col gap-4 rounded-3xl bg-primary p-6 text-primary-foreground sm:p-8">
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-primary-foreground px-6 py-3 text-base font-medium text-primary transition-all hover:-translate-y-0.5 hover:bg-cream"
                  >
                    <MessageCircle className="h-5 w-5" />
                    LINE 預約
                  </a>
                  <a
                    href={PHONE_HREF}
                    className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-primary-foreground/30 px-6 py-3 text-base font-medium text-primary-foreground transition-all hover:bg-primary-foreground/10"
                  >
